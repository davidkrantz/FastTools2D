...
% Compute solution with Spectral Ewald
[~, pr_ewald, pk_ewald, xi] = StokesDLP_pressure_ewald_2p(xsrc, ysrc, ...
    xtar, ytar, n1, n2, f1, f2,  Lx, Ly, 'verbose', 1, 'tol', tol);

fprintf('CHECKING REAL SUM...\n');
% Compute direct sums
pr_direct = stokes_dlp_pressure_real_ds(xsrc, ysrc, xtar, ytar,...
...
pk_direct = stokes_dlp_pressure_kspace_ds(xsrc, ysrc, xtar, ytar,...
