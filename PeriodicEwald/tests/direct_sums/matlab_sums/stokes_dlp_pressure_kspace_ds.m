function pk = stokes_dlp_pressure_kspace_ds(xsrc,ysrc,xtar,ytar,n1,n2,f1,f2,Lx,Ly,xi,kinf)
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    for m = 1:Ntar      
        ...
        for jk1 = -kinf+1:kinf 
            ...
            for jk2 = -kinf+1:kinf
                ...
                tmp = stresslet_pressure_k_sum(k1, k2, f1(n), f2(n),n1(n),n2(n), xi);
...
function pk = stresslet_pressure_k_sum(k1, k2, f1, f2, n1, n2, xi)
    ...
    pk = -kdotf*kdotn*exp(-k^2/(4*xi*xi))/k^2;
end
