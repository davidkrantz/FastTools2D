...
//     double* Hhat1_re = NULL;
//     double* Hhat1_im = NULL;
//     double* Hhat2_re = NULL;
//     double* Hhat2_im = NULL;
//    
//     ExtractRealIm(fft2lhs[0], Hhat1_re, Hhat1_im, Mx, My);
//     ExtractRealIm(fft2lhs[1], Hhat2_re, Hhat2_im, Mx, My);
//     
