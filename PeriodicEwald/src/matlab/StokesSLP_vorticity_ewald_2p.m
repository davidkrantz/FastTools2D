function [omega, omegar, omegak, xi] = StokesSLP_vorticity_ewald_2p(xsrc, ysrc,...
...
omegar = mex_stokes_slp_vorticity_real(psrc,ptar,f,xi,nside_x,nside_y,Lx,Ly);
...
omegak = mex_stokes_slp_vorticity_kspace(psrc,ptar,xi,eta,f,Mx,My,Lx,Ly,w,P);
